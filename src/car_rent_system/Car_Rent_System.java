...
//        Connection  con= DriverManager.getConnection("jdbc:mysql://localhost:3306/crents1?useSSL=false","root", "");
////        String query = "Create table users (ID int primary key, name char(30) not null, email char(40) not null ,password char(20) not null , phone char(10) not null)";
////        Statement stat = con.createStatement();
////        stat.execute(query);
//
//
//String Q = "Create table Customers (ID int )"
//    new UserPage(con).setVisible(true);
